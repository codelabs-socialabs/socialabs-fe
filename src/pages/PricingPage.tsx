  ...
  return (
    <div className=" bg-neutral-50 relative">
        ...
        <div className="max-w-7xl mx-auto pt-36">
            ...
            <p className="text-center text-gray-700">Socialabs offers simple and transparent pricing plans with no surprises.</p>
            ...
            <div className="flex justify-center gap-8 mt-8">
                <div className="border border-gray-300 w-80 h-128 bg-white rounded-2xl p-6 hover:shadow-md">
                    ...
                    <div className="flex items-center gap-3"><Check size={24 }/>Email Support</div>
                    <div className="flex items-center gap-3"><Check size={24 }/>Basic Analytics</div>
                ...
                <div className="border border-red-400 w-80 h-128 bg-white rounded-2xl p-6 hover:shadow-md">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-medium text-red-500">— Most popular</span>
                    </div>
        ...
        <div className="max-w-6xl mx-auto mt-12">
            <h2 className="text-3xl font-semibold text-center mb-2">Compare plan features</h2>
            <p className="text-sm text-gray-600 text-center">Discover our plans and find the one that fits your workspace needs.</p>
            ...
            <div className="grid grid-cols-4 gap-x-6 mt-16">
                ...
                <div className="col-span-4 font-semibold mb-2">
                    General
                </div>
                ...
                <div className="py-3 border-b border-b-gray-300"><Check size={24} className="text-blue-600"></Check></div>
                <div className="py-3 border-b border-b-gray-300"><Check size={24} className="text-blue-600"></Check></div>
                <div className="py-3 border-b border-b-gray-300"><Check size={24} className="text-blue-600"></Check></div>
