    ...
    <div className="overflow-hidden bg-neutral-50 relative">
      ...
      <div className="relative p-88">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center px-6">
          ...
          <h2 className="text-4xl md:text-5xl font-semibold text-gray-900 leading-tight">
            ...
            <span className="text-red-500">social data</span> meaningful
          </h2>

          <p className="mt-6 text-lg text-gray-600">
            Socialabs is an AI-powered social media analytics platform that
            helps teams understand conversations, detect trends, and turn social
            noise into actionable insights.
          </p>
        </div>
      </div>
      ...
      <div className="mt-2 max-w-6xl mx-auto ">
        ...
        <p className="text-gray-600">
          Discover how Socialabs evolved into an AI-powered platform for
          understanding social media conversations and trends.
        </p>
        ...
        <div className="relative mt-12">
          ...
          >
            {timelines.map((item) => (
              <div key={item.year} className="min-w-[320px]">
                {/* Dot + Year */}
        ...
        <div className="grid grid-cols-3 gap-x-12 gap-y-10 mt-12">
          {values.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="border border-gray-300 rounded-xl bg-white p-5 hover:shadow-md"
              >
